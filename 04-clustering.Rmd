...
cowplot::plot_grid(plotlist = kmeans_plot_list, ncol = 2)
```
...
cowplot::plot_grid(plotlist = walktrap_plot_list, ncol = 2)
```
...
cowplot::plot_grid(plotlist = louvain_plot_list, ncol = 2)
```
