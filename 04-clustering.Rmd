...
```{r}
walktrap_bootstrapping_df <- plot_cluster_stability(sample_290_normalized, c(5:25), 5, "graph", cluster_function = "walktrap")
...
```{r}
louvain_bootstrapping_df <- plot_cluster_stability(sample_290_normalized, c(5:25), 5, "graph", cluster_function = "louvain")
