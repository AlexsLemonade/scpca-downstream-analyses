...
kmeans_cluster_names <- paste("kcluster", c(2:15), sep = "_")
...
walktrap_cluster_names <-paste("walktrap_cluster", c(5, 10, 15, 20, 25, 50, 100), sep = "_")
...
louvain_cluster_names <- paste("louvain_cluster", c(5, 10, 15, 20, 25, 50, 100), sep = "_")
