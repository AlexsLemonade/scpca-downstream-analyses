...
The first plot shows the cutoff used for the maximum probability of a cell being compromised.
The second plot indicates which cells have been removed using binary values.
When `manual` filtering is implemented, one plot is displayed.
The plot in this case represents the manual filtering cutoffs for maximum percent mitochondrial reads per cell and the minimum number of genes detected per cell.
