...
params:
  ...
  marker_genes: "data/anderson-single-cell/marker-genes/mapped_marker_genes.tsv"
  date: !r Sys.Date()
...
normalized_sce_logcounts_matrix <- normalized_sce_logcounts_matrix[,colnames(normalized_sce_logcounts_matrix) %in% marker_genes[[ensembl_id_column_sym]]]

# transform counts into z-scores
normalized_sce_zscores_matrix <- scale(normalized_sce_logcounts_matrix,
                                    center = TRUE, scale = TRUE)

# prepare the matrix for heatmap plotting
normalized_sce_zscores_matrix <- prepare_matrix_colnames(
...
column_annotation <- prepare_heatmap_annotation(normalized_sce_zscores_matrix,
                                                marker_genes,
                                                gene_id_column,
